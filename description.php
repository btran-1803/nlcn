  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php"><img alt="Brand" src="img/zhenyanegg.png" style="width: 70px; margin-left: 36px; margin-top: -13px;"></a>
      </div>
    ...
    <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
      <div>
        <form role="search" action="Result.php" method="post">
          <input type="text" name="keyword" class="form-control" placeholder="Tìm kiếm sản phẩm yêu thích" style="width:80%;margin:20px 10% 20px 10%;">
        </form>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      echo '                           <br><br><br>
                                <a id="buyLink" href="' . $target . '" class="btn btn-lg btn-danger" style="padding:15px;color:white;text-decoration:none;"> 
                                    Thêm vào giỏ hàng ' . $row["Price"] . ' đ<br>
  ...
  <div class="container-fluid" id="service">
    <div class="row">
      <div class="col-sm-6 col-md-3 text-center">
        ...
        24/7 <br>
        Hỗ trợ 24/7, hãy liên lạc vào số điện thoại 01111111.
      </div>
      <div class="col-sm-6 col-md-3 text-center">
